"use strict";
var _ie, _firefox, _opera, _webkit, _chrome, _ie_real_version, _osx, _windows, _linux, _android, _win64, _iphone, _ipad, _native, _mobile, useHasFeature, _populated = !1;
function _populate() {
    if (!_populated) {
        _populated = !0;
...
function isEventSupported(e, t) {
    ...
    return !s && useHasFeature && "wheel" === e && (s = document.implementation.hasFeature("Events.wheel", "3.0")),
    s
}
...
function normalizeWheel(e) {
    ...
    (s || n) && e.deltaMode && (1 == e.deltaMode ? (s *= LINE_HEIGHT,
...
class ClapatSlider {
    constructor(e, t={}) {
        ...
        this.isElement(e))
            ...
            for (let e = 0; e < i.length; e++) {
                let s = i[e];
                0 == e ? (this.el = s,
                this.el.clapat_slider = this) : new ClapatSlider(s,t)
            }
        }
    ...
    setup() {
        ...
        for (let e = 0; e < i.length; e++) {
            let t = i[e]
              ...
              , h = null;
            "vertical" == this.opts.direction ? (h = {
                el: t,
                start: l,
                end: a,
                length: o,
            ...
            this.length += r),
            t.classList.contains(this.opts.clones) ? (this.itemsCloned.push(h),
            h.clone = !0) : (this.itemsInitial.push(h),
            h.clone = !1),
            this.items.push(h)
        }
        ...
        if ("vertical" == this.opts.direction) {
            for (let e = 0; e < s; e++) {
                ...
                t.nextElement = e == s - 1 ? this.items[this.items.length - 1] : this.items[e + 1]
            }
            for (let e = this.items.length - 1; e >= s; e--) {
                let t = this.items[e];
                e == this.items.length - 1 ? t.prevElement = this.items[s - 1] : t.prevElement = this.items[e + 1],
                t.nextElement = e == s ? this.items[0] : this.items[e - 1]
            }
        } else
            for (let e = 0; e < this.items.length; e++) {
                let t = this.items[e];
                t.prevElement = 0 == e ? this.items[this.items.length - 1] : this.items[e - 1],
                e == this.items.length - 1 ? t.nextElement = this.items[0] : t.nextElement = this.items[e + 1]
            }
        for (let e = 0; e < this.items.length; e++) {
            let t = this.items[e];
        ...
        if (null != this.el && 0 != this.opts.click && this.el.addEventListener("click", this.onClick),
        this.setupWebGL(),
        gsap.ticker.add(this.tick),
        this.threadAutoplay = null,
        this.opts.autoplay) {
            let e = 5e3;
            this.isObject(this.opts.autoplay) && this.opts.autoplay.hasOwnProperty("speed") && (e = this.opts.autoplay.speed),
    ...
    calc() {
        let e = this.state;
        if (e.current += (e.target - e.current) * this.opts.ease,
    ...
    updateUI() {
        ...
        null != this.el && (this.state.currentMovingDirection >= 0 ? (this.el.classList.contains("bw") && this.el.classList.remove("bw"),
        ...
        for (let r = 0; r < this.items.length; r++) {
            ...
            if (Math.abs(d) < o.length / 2 ? (o.el.classList.add("clapat-slide-active"),
            ...
            null != a && a !== this.state.currentSlideItem && "function" == typeof this.opts.on.activeSlideChanged && this.opts.on.activeSlideChanged(this.state.currentSlideItem.el, this.state.currentSlideItem.prevElement.el, this.state.currentSlideItem.nextElement.el)) : (o.el.classList.remove("clapat-slide-active"),
            ...
            o.translate != h) {
                ...
                e && !t && "function" == typeof this.opts.on.slideLeaveViewport && this.opts.on.slideLeaveViewport(o.el),
                !e && t && "function" == typeof this.opts.on.slideEnterViewport && this.opts.on.slideEnterViewport(o.el);
                let l = this.isItemInsideView(s, o);
                n && !l && "function" == typeof this.opts.on.slideLeave && this.opts.on.slideLeave(o.el),
                !n && l && "function" == typeof this.opts.on.slideEnter && this.opts.on.slideEnter(o.el)
            }
        }
    ...
    effects() {
        ...
        for (let s = 0; s < this.items.length; s++) {
            let n = this.items[s]
              , l = i;
            if (l < 0 && n.end + l < e + t + n.length - this.length && (l += this.length),
                        ...
                        if (void 0 !== s.element && void 0 !== s.factor) {
                            ...
                            for (let e = 0; e < t.length; e++) {
                                let i = t[e]
                                  ...
                                  , n = /rotate\(([^)]+)\)/
                                  , a = "";
                                a = s.search(n) >= 0 ? s.replace(n, "rotate(" + l + "deg)") : s + " rotate(" + l + "deg)",
                                i.style.transform = a
                            }
                        }
                    }
                        ...
                        if (void 0 !== s.element && void 0 !== s.factor) {
                            ...
                            for (let e = 0; e < t.length; e++) {
                                let i = t[e]
                                  ...
                                  , n = /scale\(([^)]+)\)/
                                  , a = "";
                                a = s.search(n) >= 0 ? s.replace(n, "scale(" + l + ")") : s + " scale(" + l + ")",
                                i.style.transform = a
                            }
                        }
                    }
    ...
    snapTargetOnWheel(e, t) {
        ...
        for (let n = 0; n < this.items.length; n++) {
            ...
            if (Math.abs(d) < l.length / 2)
                return a == n && Math.abs(t - e) < this.length ? (this.log("Snapping - start and end items are the same, the scroll did not go over a full item"),
                this.state.currentMovingDirection > 0 ? d < 0 ? t - (l.length / 2 + d + l.nextElement.length / 2) : t - d : d < 0 ? t - d : t - d + l.prevElement.length) : (this.log("Snapping - start and end items are different"),
                t - d)
        }
        return t
    }
    ...
    onMove(e) {
        ...
        "vertical" == this.opts.direction ? t.target = n + r * this.opts.speed : t.target = n + a * this.opts.speed
    }
    onUp(e) {
        if (!this.enabled)
            return;
    ...
    isItemInsideView(e, t) {
        let i = 0
          ...
          , l = t.end + t.translate;
        return "vertical" == this.opts.direction ? (i = e.top + 5,
        s = e.bottom - 5) : (i = e.left + 5,
        s = e.right - 5),
        l > i && n < s
    }
    distanceToCenter(e) {
    ...
    onPrev(e) {
        ...
        for (let e = 0; e < this.items.length; e++) {
            ...
            Math.abs(r) < l.length / 2 && (this.state.target = this.state.target - r + l.prevElement.length,
            this.state.off = this.state.target)
        }
    }
    onNext(e) {
        ...
        for (let e = 0; e < this.items.length; e++) {
            ...
            a > 0 && l.end + a > this.length && (a -= this.length);
            let r = l.start + a - (i + (t - l.length) / 2);
            Math.abs(r) < l.length / 2 && (this.state.target = this.state.target - (l.length / 2 + r + l.nextElement.length / 2),
            this.state.off = this.state.target)
        }
    }
    onWheel(e) {
        ...
        let t = performance.now()
          , i = this.state
          , s = .2 * normalizeWheel(e).pixelY
          , {x: n, y: l} = this.getPos(e);
        i.flags.dragging = !1;
        let {off: a, on: r} = i;
        if (this.log("Event timestamp: " + t + " Scroll delta " + s),
    ...
    updateWheelSnap() {
        if (this.opts.snap && this.snapWheelEvents.events.length > 0) {
            ...
            if (e - this.snapWheelEvents.events[this.snapWheelEvents.events.length - 1].ts > this.opts.snapwait.before) {
                ...
                "vertical" == this.opts.direction ? d.y = o.target : d.x = o.target,
                o.off = o.target,
        ...
        let i = this
          ...
          , n = function(e) {
            ...
            if (i.state.prevRounded > i.state.currentRounded && n > i.state.progress)
                console.log("fBeginTransition: Moving forward but we rewind. Current index: " + e + " Position: " + i.state.progress);
            else if (i.state.prevRounded < i.state.currentRounded && n < i.state.progress)
                console.log("fBeginTransition: Moving backward but we fast forward. Current index: " + e + " Position: " + i.state.progress);
          ...
          , l = function(e) {
            let t = Math.round(-i.length / 2 * 100) / 100
              , n = gsap.utils.wrap(0, 1, i.state.prevRounded / t);
            if (i.state.prevRounded > i.state.currentRounded && n > i.state.progress)
                return console.log("fEndTransition: Moving forward but we rewind. Current index: " + e + " Position: " + i.state.progress),
                void (s.material.uniforms.dispFactor.value = 0);
            if (i.state.prevRounded < i.state.currentRounded && n < i.state.progress)
                return console.log("fEndTransition: Moving backward but we fast forward. Current index: " + e + " Position: " + i.state.progress),
                void (s.material.uniforms.dispFactor.value = 0);
            if (e >= a && (e = 0),
            i.state.currentMovingDirection < 0) {
        ...
        if (i.opts.snap) {
            ...
            s.onTexturesLoaded = function() {
                ...
                for (let r = 0; r < a; r++)
                    0 == r ? i.tl.to({}, {
                        duration: e / 2
                    }, 0).call(n, [0], ">").to(s.material.uniforms.dispFactor, {
                        duration: t,
                        value: 1,
                        ease: "Sine.easeInOut"
                    }, ">").call(l, [1], ">") : i.tl.to({}, {
                        duration: e
                    }, ">").call(n, [r], ">").to(s.material.uniforms.dispFactor, {
                        duration: t,
                        value: 1,
                        ease: "Sine.easeInOut"
                    }, ">").call(l, [r + 1], ">")
...
class ClapatGridPreview {
    constructor(e, t={}) {
        ...
        this.btnNext = this.btnPrev = null,
        this.slider.isObject(this.opts.navigation) || 1 == this.opts.navigation && (this.btnNext = document.querySelector(".cp-button-next"),
        this.btnPrev = document.querySelector(".cp-button-prev")),
        this.slider.isObject(this.opts.navigation) && (this.btnNext = document.querySelector(this.opts.navigation.nextEl),
        this.btnPrev = document.querySelector(this.opts.navigation.prevEl)),
        this.noItemsPrev = this.noItemsNext = -1,
        this.slider.isObject(this.opts.limit) && (this.noItemsPrev = this.opts.limit.prev,
    ...
    showGrid() {
        ...
        this.allImages = this.DOM.grid.map((e => (e.item.DOM.image.setAttribute("data-slide-index", e.item_index),
        e.item.DOM.image))),
        ...
        this.slider && gsap.set(this.currentImage.closest(this.slider.opts.slides), {
            zIndex: 0
        }),
    ...
    hideGrid() {
        ...
        for (i.classList.remove("flip-next-thumb", "flip-prev-thumb"); i.firstChild; )
            i.removeChild(i.firstChild);
        "function" == typeof this.on.flipHideGrid && this.on.flipHideGrid(e, t)
    }
    getDOMElements() {
        if (this.slider)
            return this.noItemsPrev >= 0 && this.noItemsNext >= 0 ? this.getRangeDOMElements() : this.getAllDOMElements()
    }
    getAllDOMElements() {
        if (!this.slider)
            return;
        ...
        if ("vertical" == s) {
            ...
            if (i >= t.length) {
                for (index = i; index >= t.length; index--) {
                    let t = e[index];
                    t.DOM.el.classList.contains(this.opts.selTriggeredItemClass) ? r = index : a.push({
                        item_index: index,
                        item: t
                    }),
                    s++
            ...
            for (; s < t.length; ) {
                let t = gsap.utils.wrap(0, e.length, i + s)
                  , n = e[t];
                n.DOM.el.classList.contains(this.opts.selTriggeredItemClass) ? r = t : a.push({
                    item_index: t,
                    item: n
                }),
                s++
    ...
    navigate(e="next") {
        ...
        const i = document.querySelector(this.opts.selTriggeredImage + " " + this.opts.selImage)
          , s = (document.querySelector(this.opts.selTriggeredImage + " " + this.opts.selImageCaption),
        document.querySelector(this.opts.selTriggeredImage + " " + this.opts.selImageInner),
        ...
        null != a ? s.replaceChild(i, a) : "next" == e ? (a = t[0],
        s.appendChild(i)) : (a = t[t.length - 1],
        s.insertBefore(i, s.firstChild)),
        n.appendChild(a);
        let o = document.querySelectorAll(this.slider.opts.slides);
        null != o[l].querySelector(this.opts.selImageWrap) && this.on.navigateTitleCaption,
    ...
    navigateRange(e="next") {
        ...
        const s = document.querySelectorAll(this.opts.selGrid + " " + this.opts.selImage)
          ...
          , l = (document.querySelector(this.opts.selTriggeredImage + " " + this.opts.selImageCaption),
        document.querySelector(this.opts.selTriggeredImage + " " + this.opts.selImageInner),
        document.querySelector(this.opts.selGrid))
        ...
        if (s.length > 0) {
            ...
            document.getElementById("clapat-page-content").classList.contains("light-content") ? p.classList.contains("change-header") ? (gsap.to("#clapat-logo img.black-logo", {
                duration: .5,
                delay: .15,
                opacity: 1,
                ease: Power2.easeInOut
            ...
            gsap.to(".button-icon-link.cp-button-prev, .button-icon-link.cp-button-next", {
                duration: .5,
                delay: .15,
                color: "#000",
                ease: Power2.easeInOut
            ...
            gsap.to(".button-icon-link.cp-button-prev, .button-icon-link.cp-button-next", {
                ...
                color: "#fff",
                ease: Power2.easeInOut
            })) : document.getElementById("clapat-page-content").classList.contains("dark-content") && (p.classList.contains("change-header") ? (gsap.to("#clapat-logo img.black-logo", {
                duration: .5,
                delay: .15,
                opacity: 0,
                ease: Power2.easeInOut
            ...
            "next" == e ? (l.classList.add("flip-next-thumb"),
            l.classList.remove("flip-prev-thumb")) : (l.classList.add("flip-prev-thumb"),
        ...
        null != t[r].querySelector(this.opts.selImageWrap) && this.on.navigateTitleCaption,
        $(this.slider.opts.slides).removeClass(this.opts.selTriggeredItemClass);
    ...
    initEvents() {
        ...
        document.querySelectorAll(this.opts.selTargetEvents).forEach((e => {
            e.addEventListener("click", (e => {
                $(this.opts.selContainer).length > 0 && (e.currentTarget.closest(this.slider.opts.slides).classList.add(this.opts.selTriggeredItemClass),
                this.showGrid())
            }
            ))
        }
        ...
        window.addEventListener("touchend", (e => {
            document.body.classList.contains("grid-open") && this.bGridSwiped && $(this.opts.selContainer).length > 0 && (this.bGridSwiped = !1,
            this.hideGrid())
        }
        ));
        ...
        null != this.btnNext && this.btnNext.addEventListener("click", this.throttle((e => {
            this.moveThumbGrid("next")
        }
        ), 1e3)),
        null != this.btnPrev && this.btnPrev.addEventListener("click", this.throttle((e => {
