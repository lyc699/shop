...
!function(t, e) {
    ...
    function A(t, e) {
        var i, n, r, a, s, o, l = v(t), u = t === l, p = l ? k : C, h = t.parentNode;
        if (t === y)
            return t;
    ...
    var g, y, r, b, c, f, d, a, m, i, w = "transform", S = w + "Origin", k = [], C = [], _ = ((i = Matrix2D.prototype).inverse = function inverse() {
        var t = this.a
          , e = this.b
          , i = this.c
          , n = this.d
    ...
    function ia(e, i, n) {
        ...
        e.isVisible && !a || (a && (ea(e, ["display"]).display = i.display),
        e.matrix = i.matrix,
        ...
        h)
            r = new pt(o);
        else if ((r = $(e, M)).position = "absolute",
        e.simple) {
    ...
    function za(t, e, r, i) {
        ...
        var a, s, o, l, u, p, h, c, f, n, d, m, g, y, v, x = (r = r || {}).clearProps, b = r.onEnter, w = r.onLeave, S = r.absolute, k = r.absoluteOnLeave, C = r.custom, V = r.delay, _ = r.paused, E = r.repeat, B = r.repeatDelay, M = r.yoyo, F = r.toggleClass, I = r.nested, L = r.zIndex, T = r.scale, P = r.fade, O = r.stagger, N = r.spin, A = r.prune, X = ("props"in r ? r : t).props, z = $(r, rt), D = Q.timeline({
            delay: V,
            paused: _,
            repeat: E,
            repeatDelay: B,
            yoyo: M,
            data: "isFlip"
        }), R = z, Y = [], j = [], G = [], q = [], U = !0 === N ? 1 : N || 0, H = "function" == typeof N ? N : function() {
            return U
        }
        , Z = t.interrupted || e.interrupted, K = D[1 !== i ? "to" : "from"];
        for (s in e.idLookup)
        ...
        m = function run() {
            ...
            l = 0; l < G.length; l++)
                ...
                g = p.a,
                y = p.b,
                !A || g.isDifferent(y) || p.entering ? (u = p.t,
                !I || p.sd < 0 || !l || (g.matrix = getGlobalMatrix(u, !1, !1, !0)),
                y.isVisible && g.isVisible ? (p.sd < 0 ? (h = new pt(u,X,t.simple),
                ot(h, g, T, 0, 0, h),
                h.matrix = getGlobalMatrix(u, !1, !1, !0),
                h.css = p.b.css,
                p.a = g = h,
                P && (u.style.opacity = Z ? y.opacity : g.opacity),
                O && q.push(u)) : 0 < p.sd && P && (u.style.opacity = Z ? g.opacity - y.opacity : "0"),
                ot(g, y, T, X)) : y.isVisible !== g.isVisible && (y.isVisible ? g.isVisible || (y.css = g.css,
                j.push(y),
                G.splice(l--, 1),
                S && I && ot(g, y, T, X)) : (g.isVisible && Y.push(g),
                G.splice(l--, 1))),
                T || (u.style.maxWidth = Math.max(g.width, y.width) + "px",
                ...
                I && F && u.classList.add(F)) : G.splice(l--, 1),
                f.push(g);
            var e;
        ...
        tt ? (S && (v = tt._abs).push.apply(v, ja(G, S)),
        tt._run.push(m)) : (S && ka(ja(G, S)),
        m());
    ...
    var T, Q, tt, s, o, P, l, n, h = 1, E = {}, O = 180 / Math.PI, N = Math.PI / 180, M = {}, F = {}, et = {}, it = R("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"), nt = R("transform,transformOrigin,width,height,position,top,left,opacity,zIndex,maxWidth,maxHeight,minWidth,minHeight"), rt = {
        zIndex: 1,
        kill: 1,
        simple: 1,
        spin: 1,
        ...
        getVars: 1,
        props: 1
    }, st = {}, I = "paddingTop,paddingRight,paddingBottom,paddingLeft,gridArea,transition".split(","), L = function _parseElementState(t, e, i, n) {
        ...
        var s, o, l, u, p, h, c, f = t.element, d = t.cache, m = t.parent, g = t.x, y = t.y, v = e.width, x = e.height, b = e.scaleX, w = e.scaleY, S = e.rotation, k = e.bounds, C = a && f.style.cssText, _ = a && f.getBBox && f.getAttribute("transform"), E = t, B = e.matrix, M = B.e, F = B.f, I = t.bounds.width !== k.width || t.bounds.height !== k.height || t.scaleX !== b || t.scaleY !== w || t.rotation !== S, L = !I && t.simple && e.simple && !r;
        return L || !m ? (b = w = 1,
        ...
        d.rotation = S + "deg",
        d.skewX = s + "deg"),
        i ? (b *= v !== E.width && E.width ? v / E.width : 1,
        w *= x !== E.height && E.height ? x / E.height : 1,
        d.scaleX = b,
        d.scaleY = w) : (v = P(v * b / E.scaleX, 0),
        x = P(x * w / E.scaleY, 0),
        f.style.width = v + "px",
        f.style.height = x + "px"),
        n && oa(f, e.props),
        L || !m ? (g += M - t.matrix.e,
        y += F - t.matrix.f) : I || m !== e.parent ? (d.renderTransform(1, d),
        ...
        d.y = y + "px",
        d.renderTransform(1, d)) : (f.style.cssText = C,
        ...
        a.skewX = s,
        i ? (a.scaleX = b,
        a.scaleY = w) : (a.width = v,
        a.height = x)),
        a || d
    }, X = [], D = "width,height,overflowX,overflowY".split(","), lt = function _killFlip(t, e) {
    ...
    n.compare = function compare(t) {
        ...
        var e, i, n, r, a, s, o, l, u = t.idLookup, p = this.idLookup, h = [], c = [], f = [], d = [], m = [], g = t.alt, y = this.alt;
        for (n in u)
            a = g[n],
            s = y[n],
            ...
            m.push(o.element, l.element)) : ih(o, l, o.element),
            a && o.element === a.element && (a = u[n]),
            jh(o.element !== i.element && a ? a : o, i, i.element),
            jh(a && a.element === s.element ? a : o, s, s.element),
            a && jh(a, s.element === a.element ? s : i, a.element)) : (i ? i.isDifferent(e) ? ih(e, i, r) : h.push(r) : f.push(r),
            a && jh(a, i, a.element));
        for (n in p)
            u[n] || (d.push(p[n].element),
            y[n] && d.push(y[n].element));
        return {
            changed: c,
            unchanged: h,
            enter: f,
    ...
    Y.update = function update(e, i) {
        ...
        n.simple = i || 1 === V(p.a) && !V(p.b) && !V(p.c) && 1 === V(p.d),
        n.uncache = 0
    }
    ,
    ElementState);
    ...
    function Flip() {}
    J.version = "3.11.4",
    "undefined" != typeof window && window.gsap && window.gsap.registerPlugin(J),
    e.Flip = J,
    e.default = J;
